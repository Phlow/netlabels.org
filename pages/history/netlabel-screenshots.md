...
{% for screenshot in site.data.netlabel_screenshots %}
  <li><a href="{{ site.url }}{{ site.baseurl }}/archive/screenshot/{{ screenshot.image }}"><img  data-caption="{{ screenshot.caption }}" class="th" src="{{ site.url }}{{ site.baseurl }}/archive/screenshot/{{ screenshot.image | replace: '.jpg', '-thumb.jpg' }}"></a></li>
{% endfor %}
</ul>
